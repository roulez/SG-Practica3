...
class Character2 extends THREE.Object3D {
  ...
  constructor (parameters) {
    ...
    var texturaTshirt = loaderTshirt.load("imgs/cuadros.jpg");
    this.materialTshirt = new THREE.MeshPhongMaterial({map: texturaTshirt});

    var loaderVaqueros = new THREE.TextureLoader();
    var texturaVaqueros = loaderVaqueros.load("imgs/vaquero2.jpg");
  ...
  createCabeza(){
    ...
    ObjLoader.load('hair.obj', function (object) {
  ...
  createTronco(){
    ...
    var troncoMesh = new THREE.Mesh(troncoGeo, this.materialTshirt);
