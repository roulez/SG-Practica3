...
class Character extends THREE.Object3D {
  ...
  createCabeza(){
    ...
    ObjLoader.load('hair2.obj', function (object) {
  ...
  createTronco(){
    ...
    var texturaDress = loaderDress.load("imgs/dress.jpg");
    var materialDress = new THREE.MeshPhongMaterial({map: texturaDress}); 

    var troncoMesh = new THREE.Mesh(troncoGeo, materialDress);
  ...
  createRightArm(anguloX, anguloZ){
    ...
    var armMesh = new THREE.Mesh(armGeo, materialDress);
    ...
    var arm = new THREE.Mesh(shoulderGeo, materialDress);
    arm.add(armMesh);
  ...
  createRightLeg(anguloX, anguloZ){
    ...
    var texture = new THREE.Texture();
    var loader = new THREE.ImageLoader(manager);
    loader.load("imgs/botas.jpg", function(image) {
        texture.image = image;
        texture.needsUpdate = true;
    });
